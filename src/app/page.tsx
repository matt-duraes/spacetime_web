...
export default function Home() {
  return <main className="grid min-h-screen grid-cols-2 bg-[url(../assets/bg-stars.svg)] bg-cover ">
    ...
    <div className="relative flex flex-col items-start justify-between overflow-hidden border-white/10 px-28 py-16 ">
      ...
      {/*Blur */}
      <div className="absolute right-0 top-1/2 h-[268px] w-[526px] -translate-y-1/2 translate-x-1/2 rounded-full
      ...
      <div className='space-y-5'>
        ...
        <a 
          ...
          leading-none hover:bg-green-600 text-black'
        >
          CADASTRAR LEMBRANÇA
        </a>
      </div>
      ...
      <div className='text-sm leading-relaxed text-gray-200'>
        Feito por {''}
        <a
          href="https://www.linkedin.com/in/mateus-dur%C3%A3es-510a17159/" 
